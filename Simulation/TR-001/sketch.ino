...
// =====================================================
// AI BASED TRANSFORMER MONITORING SYSTEM - V2
...
// DHT22 is kept at 1 second for stable readings.
// Firebase updates faster so website synchronization feels
// more responsive whenever new sensor values are available.
...
void setup()
{
  ...
  Serial.println();
  Serial.println("========================================");
  Serial.println(" AI BASED TRANSFORMER MONITORING SYSTEM");
  Serial.println(" ESP32 + FIREBASE V2");
  Serial.println(" TRANSFORMER: TR-001");
  Serial.println("========================================");
  ...
  Serial.println("Starting TR-001 monitoring...");
  Serial.println();
}
...
{
  Serial.println();
  Serial.println("===== FIREBASE TR-001 UPDATE =====");
  ...
  // Reduced timeout for smoother simulation
