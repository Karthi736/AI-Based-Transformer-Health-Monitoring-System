...
void setup()
{
  ...
  Serial.println(" TRANSFORMER: TR-002");
  Serial.println("========================================");
  ...
  Serial.println("Starting TR-002 monitoring...");
  Serial.println();
}
...
{
  Serial.println();
  Serial.println("===== FIREBASE TR-002 UPDATE =====");
