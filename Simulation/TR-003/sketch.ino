// =====================================================
// SMART TRANSFORMER MONITORING SYSTEM - TR-003
...
void setup()
{
  ...
  Serial.println(" TRANSFORMER: TR-003");
  Serial.println("========================================");
  ...
  Serial.println("Starting TR-003 monitoring...");
  Serial.println();
}
...
void sendToFirebase()
{
  ...
  Serial.print("TR-003 Firebase HTTP Code: ");
